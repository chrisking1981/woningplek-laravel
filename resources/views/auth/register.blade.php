...
<section class="py-8">
    <div class="container mx-auto px-4">
        <div class="bg-white p-6 rounded shadow">
            <h2 class="text-2xl font-bold mb-4">Account maken</h2>
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Account maken</button>
                </div>
            </form>
        </div>
    </div>
