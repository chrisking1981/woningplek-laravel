        ...
        <nav class="bg-gray-900 text-white p-4">
            <div class="container mx-auto flex justify-between items-center">
                <div class="flex items-center">
                    <div class="text-lg font-bold mr-6">Logo</div>
                    <a href="#" class="mr-4 hover:underline">Home</a>
                    <a href="#" class="mr-4 hover:underline">Categories</a>
                    <a href="#" class="mr-4 hover:underline">About Us</a>
                    <a href="#" class="mr-4 hover:underline">Contact</a>
                </div>
                <div>
                    <a href="#" class="mr-4 hover:underline">Post an Ad</a>
                    <a href="#" class="hover:underline">My Account</a>
                </div>
            </div>
        </nav>
        <main class="flex-grow bg-blue-100 dark:bg-blue-900 w-full">
